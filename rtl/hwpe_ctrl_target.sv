 ...
 * PeakRDL; 2) plugging the OBI interface signals to the SystemRDL-generated
 * register interface block; 3) plugging `hwif_in` and `hwif_out` to the
 * same block.
 *
 ...
 *   +---------------------------+--------------+----------------------------------------------------------------------------+
 *   | *ID_WIDTH*                | 2            | Width of the transaction ID on the OBI register-file interface.            |
 *   +---------------------------+--------------+----------------------------------------------------------------------------+
 *   | *ADDR_WIDTH*              | 16           | Width of the address on the OBI register-file interface.                   |
 *   +---------------------------+--------------+----------------------------------------------------------------------------+
